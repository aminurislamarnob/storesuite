...
class DashboardMenu {
	...
	public function get_dashboard_menus(): array {
		$menus = array(
			...
			'edit-history' => array(
				'title'      => __( 'History', 'storesuite' ),
				'icon'       => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M12,0C5.383,0,0,5.383,0,12s5.383,12,12,12,12-5.383,12-12S18.617,0,12,0Zm0,22c-5.514,0-10-4.486-10-10S6.486,2,12,2s10,4.486,10,10-4.486,10-10,10Zm4.707-8.707c.391,.391,.391,1.023,0,1.414-.195,.195-.451,.293-.707,.293s-.512-.098-.707-.293l-4-4c-.188-.188-.293-.442-.293-.707V6c0-.553,.448-1,1-1s1,.447,1,1v5.586l3.707,3.707Z"/></svg>',
				'url'        => storesuite_get_navigation_url( 'edit-history' ),
				'pos'        => 55,
				'permission' => 'manage_woocommerce',
				'target'     => '_self',
			),
